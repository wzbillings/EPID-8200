...
@tab-sequence-numbers. The years for which each strain was used are shown in
@tab-strain-years.
...
knitr::include_graphics(here::here("Results/table1-midterm.png"))
```

```{r}
#| label: tab-strain-years
...
col_matrix <- ifelse(years_tab[, -1] == "x", "gray", "white")
...
years_tab |>
	...
	#             colwidths = c(5, 6)) |>
	#flextable::merge_at(j = 1:4, part = "footer") |>
	# flextable::align(j = 6:11, align = "center") |>
	flextable::autofit()

```

```{r}
#| label: tab-sequence-numbers
short_names_used <-
...
readr::read_rds(here::here("results", "virus_accession.rds")) |>
	...
	# 	top = FALSE, 
	# 	season = paste0(
	# 		"If the full length sequence was not available the numbering of the",
	# 		"residues that are available are listed."
	# 	)
	# ) |>
	#flextable::add_header_row(top = TRUE,
	#             values = c(" ", "Season Used in HAI panel"),
